...
<ion-modal :is-open="modal">
    ...
    <ion-content class="ion-padding">
        <br>
        <ion-input label="Ingresa el carnet del usuario" color="primary" label-placement="stacked" maxlength="6"
            counter fill="outline" shape="round" clear-input="true" v-model="usuario.carnet" type="number">
        </ion-input>
        <br>
        <ion-input label="Ingresa el correo del usuario" color="primary" label-placement="stacked" maxlength="30"
            counter fill="outline" shape="round" clear-input="true" v-model="usuario.correo">
        </ion-input>
        <br>
        <ion-input label="Ingresa el nombre del usuario" color="primary" label-placement="stacked" maxlength="30"
            counter fill="outline" shape="round" clear-input="true" v-model="usuario.usuario">
        </ion-input>
        <br>
...
methods:{
    ...
    agregarUsuario() {
        ...
        axios.post(this.globalVar+'usuario/store', this.usuario)
        .then(response => {
